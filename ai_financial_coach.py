...
def display_budget_analysis(analysis: Dict[str, Any]):
    ...
    if "spending_categories" in analysis:
        ...
        fig = px.pie(
            ...
            title="Your Spending Breakdown (INR)"
        )
        st.plotly_chart(fig)
    ...
    if "total_expenses" in analysis:
        ...
        fig.update_layout(title="Monthly Income vs. Expenses (INR)")
        st.plotly_chart(fig)
...
2024-01-01,Housing,12000.00
2024-01-02,Food,1500.00
2024-01-03,Transportation,450.00"""
